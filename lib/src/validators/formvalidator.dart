...
typedef ConditionalValidateFunction<T> = bool Function(T? value, T? conditionalValue);
...
class FormValidators {
  ...
  static FieldValidator<T> required<T>(String errorMessage) => FieldValidator<T>(
      validate: (T? value) =>
  ...
  static FieldValidator<T> email<T>(String errorMessage, [bool enableEmpty = false]) =>
      FieldValidator<T>(
  ...
  static FieldValidator<T> minLength<T>(int minLength, String errorMessage) => FieldValidator<T>(
  ...
  static FieldValidator<T> maxLength<T>(int maxLength, String errorMessage) => FieldValidator<T>(
      validate: (T? value) => value is String ? value.length <= maxLength : false,
      errorMessage: errorMessage);
  ...
  static FieldValidator<T> containLowercase<T>(String errorMessage) => FieldValidator<T>(
      validate: (T? value) =>
  ...
  static FieldValidator<T> containNumber<T>(String errorMessage) => FieldValidator<T>(
      validate: (T? value) =>
  ...
  static FieldValidator<T> containUppercase<T>(String errorMessage) => FieldValidator<T>(
      validate: (T? value) =>
  ...
  static FieldValidator<T> containSpecialCharacter<T>(String errorMessage) => FieldValidator<T>(
